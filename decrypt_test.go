...
type testDecryptStruct struct {
	algorithmName, hashFunc, testFixture string
}
...
var testDecryptData = []testDecryptStruct{
	{algorithmName: "RSA PKCS #1 v1.5", testFixture: RSAPKCS1v15EncryptedTestFixture},
	{algorithmName: "RSA-OAEP", hashFunc: "SHA-1", testFixture: RSAOAEPSHA1EncryptedTestFixture},
	{algorithmName: "RSA-OAEP", hashFunc: "SHA-256", testFixture: RSAOAEPSHA256EncryptedTestFixture},
}
